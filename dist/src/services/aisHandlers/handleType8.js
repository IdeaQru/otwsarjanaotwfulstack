...
const handleType8 = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const aisType8Data = new aisType8data_1.default({
        type: data.type,
        mmsi: data.mmsi,
        binaryData: data.binaryData,
        timestamp: new Date(),
    });
    yield aisType8Data.save();
...
exports.handleType8 = handleType8;
